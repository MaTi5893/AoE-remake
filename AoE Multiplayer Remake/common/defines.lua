...
country = {
    ...
    GOLD_TO_CASH_RATE = 0.78, -- Amount of money generated per gold unit
...
economy = {
    ...
    TRADE_CAP_LOW_LIMIT_NAVAL = 0.8,             -- the lowest % the slider can go for naval units
...
military = {
    ...
    SIEGE_BRIGADES_MAX = 16, -- the number of brigades above which you get no addition benefit in sieges
    SIEGE_BRIGADES_BONUS = 0.4, -- the bonus to siege speed from each brigade
    RECON_SIEGE_EFFECT = 0.4, -- multiplier to effect of recon on speeding up sieges
    SIEGE_ATTRITION = 2, -- fixed attrition on sieging units
    BASE_MILITARY_TACTICS = 1.5, -- base mil tactics before tech
    NAVAL_LOW_SUPPLY_DAMAGE_SUPPLY_STATUS = 0.45, -- how little supply is acceptable before getting damage to STR
    NAVAL_LOW_SUPPLY_DAMAGE_DAYS_DELAY = 20, -- delay in days before the STR will get damage due to no supplies. Sometimes supply status may jump bcoz of the market.
