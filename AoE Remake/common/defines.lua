...
military = {
    ...
    SIEGE_BRIGADES_MIN = 6, -- the number of brigades needed for a siege to progress at normal speed
    SIEGE_BRIGADES_MAX = 26, -- the number of brigades above which you get no addition benefit in sieges
    SIEGE_BRIGADES_BONUS = 0.25, -- the bonus to siege speed from each brigade
